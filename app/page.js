...
const page = () => {
  ...
  const cities = [
    "Navsari","Surat","Mumbai","Ahmedabad",
    "Hyderabad","Kolkata","Pune","Chennai",
  ];
        ...
        <div className="col-md-5">
          <div className="card shadow-lg border-0 rounded-4">
            <div className="card-body">
              <h3 className="text-center mb-4 text"> <span className="fs-1">Form</span></h3>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mt-3">
                  ...
                  <input type="checkbox" name="hobby" value="Cricket"
                    onChange={handleChange} checked={hobby.includes("cricket")} /> Cricket
                  <input type="checkbox" name="hobby" value="Games"
                    className="ms-3"
                    onChange={handleChange} checked={hobby.includes("games")} /> Games
                </div>
          ...
          <div className="table-responsive">
            <table className="table table-hover text-center align-middle">
              <thead className="table-dark">
                <tr>
                  <th>Sr.No</th><th>Name</th><th>Email</th>
